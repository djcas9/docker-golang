...
RUN apt-get install -y subversion cmake ruby-dev gcc git rpm mercurial gcc-multilib libc6-i386 ruby-dev build-essential autoconf rpm libsqlite3-dev sqlite3
